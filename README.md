...
# 🐚 Лабораторная работа: Docker + Pascal
...
Познакомиться с Docker на практике: создать контейнер для программы на Pascal и убедиться, что даже старый добрый Pascal может жить в облаках 🐳✨
